                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-black border p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div class="flex items-center mt-2">
                    ...
                    <input
                      ...
                      class="block w-full rounded-l-none rtl:rounded-l-lg rtl:rounded-r-none rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-200 dark:text-black dark:focus:border-blue-300"
                    />
                  </div>
                  <div className="mt-4">
                    <button
